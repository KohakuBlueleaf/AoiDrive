class DraggableBar{
  constructor(id,methods,properties,set_html=true){
      ...
      'mousedown',function(event){
        if(self.enable==true){
          ...
          document.onmouseup = function(event){
            ...
            document.onpointermove = document.onmouseup = null
          }
        }
      }
    )
      ...
      'pointerdown',function(event){
        if(self.enable==true){
          ...
          document.ontouchmove = function(event){
            var p = (event.changedTouches[0].pageX-start)/self.bar.offsetWidth
            if(self.set_pos_offset(p,pos)){
              methods.drag(self, event, p+pos)
            }
          }
